       ...
       <div>
           <h1>Create your own token using JavaScript</h1>
           {
            ...
            </button> 
            {
               walletConnected ? (
                  <ul>
                     <li>Airdrop 1 SOL into your wallet <button disabled={loading} onClick={airDropHelper}>AirDrop SOL </button></li>
                     <li>Create your own token <button disabled={loading} onClick={initialMintHelper}>Initial Mint </button></li>
